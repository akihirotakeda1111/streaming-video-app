...
- The runner supports selecting implemented scenarios and lists available selectors. An unknown/unimplemented selector fails; the final full sequence is assembled by Spec 48.
