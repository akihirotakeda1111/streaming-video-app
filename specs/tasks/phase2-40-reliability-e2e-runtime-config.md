...
- This file replaces the original monolithic validation scope with the first of ten work units: 40 runtime configuration -> 41 evidence and component matrix -> 42 preflight -> 43 duplicate delivery -> 44 crash/heartbeat -> 45 FFmpeg attempt exhaustion -> 46 poison DLQ isolation -> 47 queue/alarm monitoring -> 48 playback regression -> 49 runbooks and final verification.
