...
| Duplicate delivery / single owner | `app/frontend/e2e/reliability/duplicate-delivery.spec.ts` | `python app/scripts/run_reliability_e2e.py --scenario duplicate-delivery` | worker ownership, correlated attempts, active-lease and post-completion observations, one effective encode/publication | Human live verification pending |
