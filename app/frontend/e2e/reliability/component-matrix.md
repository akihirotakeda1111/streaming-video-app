...
| Invalid media / FFmpeg, exhaustion and failed-job DLQ isolation | Spec 45 live scenario | successor selector pending | redacted errors, bounded attempts, durable FAILED, no manifest-backed playback, correlated DLQ message, UTC timestamps | Pending — Spec 45 |
| Malformed / unknown-job poison input and DLQ isolation | Spec 46 live scenario | successor selector pending | correlated poison DLQ messages, no job mutation or known-job attempt consumption, concurrent valid-job completion, UTC timestamps | Pending — Spec 46 |
